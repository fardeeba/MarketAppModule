...
class SlidingTabStrip extends LinearLayout {
    ...
    SlidingTabStrip(Context context, AttributeSet attrs) {
        ...
        mDefaultTabColorizer.setIndicatorColors(ContextCompat.getColor(context, R.color.categoriesSelectedColor));

        mBottomBorderThickness = (int) (DEFAULT_BOTTOM_BORDER_THICKNESS_DIPS * density);
        mBottomBorderPaint = new Paint();
        mBottomBorderPaint.setColor(ContextCompat.getColor(context, R.color.categoriesSelectedColor));
